...
public:
    ...
    */
    ...
    /*!
        Приглашение к вводу очередной команды интерфейса
    */
    void invite();

    /*!
        Сообщение пользователю о завершение взаимодействия с интерфейсом
    */
    void leave();
    ...
    */
    ...
    /*!
        Чтение очередных типизированных данных из потока
        \return Искомые типизированные данные от пользователя
    */
